...
const services = [
  ...
  },
  {
    ...
    text: "Разработка сайтов на WordPress и Tilda, от лендингов до крупных интернет-магазинов.",
    price: "от 20 000 ₽",
  },
  {
    icon: "R",
...
const reviews = [
  {
    ...
    text: "CoreDevs сделали нам сайт на Tilda и Telegram-бота. Продажи выросли на 40%, всё в личном кабинете понятно.",
    name: "Анна Смирнова",
  ...
  return (
    <main className="min-h-screen bg-[#090909] px-3 py-5 text-[#f5f5f1] sm:px-5 lg:px-8">
      <div className="mx-auto flex max-w-[1380px] flex-col gap-5">
        <header className="animate-fade-up sticky top-4 z-50 flex min-h-20 items-center justify-between rounded-[14px] border border-white/5 bg-[#171717]/92 px-6 shadow-[0_18px_70px_rgba(0,0,0,0.36)] backdrop-blur-xl">
        ...
        <section className="grid gap-3 lg:grid-cols-[1.95fr_1fr]" id="главная">
          <div className="animate-fade-up group relative overflow-hidden rounded-[16px] border border-white/5 bg-[#171717] p-8 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.02)] sm:p-12 lg:min-h-[430px] lg:p-14">
            ...
            <div className="relative z-10 flex h-full max-w-3xl flex-col justify-center">
              ...
              <h1 className="max-w-4xl text-5xl font-black uppercase leading-[0.92] tracking-[-0.03em] text-white sm:text-7xl lg:text-[86px]">
                Core Devs
              </h1>
              <p className="mt-5 max-w-3xl text-sm font-bold uppercase tracking-[0.14em] text-white/82">
                Создаём современные цифровые решения для вашего бизнеса
              </p>
              <p className="mt-7 max-w-2xl text-base leading-7 text-white/43">
                Разработка сайтов, Telegram-ботов и веб-приложений, которые продают и автоматизируют процессы.
              </p>
            </div>
          </div>
          ...
          <article className="animate-fade-up group relative overflow-hidden rounded-[16px] border border-white/5 bg-[#171717] [animation-delay:90ms]">
            ...
            <div className="p-7">
              ...
              <p className="mt-1 text-sm text-white/45">IT-разработка</p>
            </div>
          </article>
        </section>
        ...
        <section className="relative mt-20 overflow-hidden rounded-[18px] bg-[#13c9e8] p-8 text-[#071012] shadow-[0_0_80px_rgba(19,201,232,0.22)] sm:p-12" id="contact">
          ...
          <div className="relative z-10 flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
            <div>
              <h2 className="max-w-4xl text-4xl font-black uppercase leading-none tracking-[-0.03em] sm:text-5xl lg:text-6xl">
        ...
        <footer className="overflow-hidden pb-5">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-[0.7fr_2fr]">
            ...
            <div className="flex h-20 items-center justify-between rounded-[14px] border border-white/5 bg-[#171717] px-8 text-sm text-white/40">

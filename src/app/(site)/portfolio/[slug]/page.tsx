      ...
      <div className="mx-auto max-w-[1380px]">
        <header className="flex min-h-20 flex-wrap items-center justify-between gap-3 rounded-[14px] border border-white/5 bg-[#171717]/92 px-5 py-4 shadow-[0_18px_70px_rgba(0,0,0,0.36)] backdrop-blur-xl sm:px-6">
          ...
          <div className="flex flex-wrap gap-2">
            <Link className="rounded-lg border border-white/10 px-5 py-3 text-xs font-black uppercase text-white/70 transition hover:border-cyan-300/40 hover:text-cyan-300" href="/portfolio">
              Все проекты
            </Link>
        ...
        <section className="mt-5 grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="rounded-[18px] border border-white/5 bg-[#171717] p-8 sm:p-12">
            ...
            <h1 className="mt-7 max-w-5xl text-4xl font-black uppercase leading-none text-white sm:text-6xl lg:text-[74px]">
              {work.title}
            </h1>
